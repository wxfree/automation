...
class MakeMp4:
    ...
    def get_m3u8(self):
        m3u8_url = ''
        response = requests.get('https://h5.nty.tv189.com/api/portal/h5inter/auth-play', params={'contid': self.contId}, headers=self.headers)
            ...
            for line in f.readlines():
                if line.startswith('#'):
                    ...
                    if line.startswith('http'):
                        ...
                        ts_url = self.prefix_path + line
                    print(line)
                    res = requests.get(ts_url, headers=self.headers)
    ...
    @classmethod
    def get_url_path(self, url_path):
